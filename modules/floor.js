...
export const setupFloor = (scene) => {
  ...
  const floorTexture = textureLoader.load('img/wooden_floor.jpg'); // load the texture
  ...
  // floorPlane.position.y = -7; // move the plane up 10 units in the Y axis
